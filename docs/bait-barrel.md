...
- 新增可制作道具「饵料桶」(🪣):二级工作台制作(树枝 ×4 + 绳线 ×1),可放置、可被锄头挖走回收。
...
- 兑换表 `BAIT_YIELD`(`systems/Food.ts`):按获取难度定价——基础采集物(橡果/松果/浆果/可乐)1,小鱼/蟹肉 2,鸟肉 3,大鱼 5,兽肉 10,黄金鱼 40;熟食比生食更值(烤小鱼 4、烤大鱼 8、烤兽肉 12、烤黄金鱼 80)。不在表内的食物不可投喂。
...
- 2026-09-05:首版。删除三种鱼饵手搓配方;新增饵料桶道具、配方、实体/系统/UI、存档与联机同步,兑换表见上。
