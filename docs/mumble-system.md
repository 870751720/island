...
气泡位于屏幕下方居中(`bottom: 112px` + 安全区),白底圆角、💭 前缀、轻微上下浮动动画;显示 4 秒后淡出,`pointerEvents: none` 不拦截任何触控。

## 迭代记录

- 2026-08-29 初版:11 种触发条件 × 20 句台词,MumbleSystem + MumbleBubble 落地,含砍树(chopWood)与挖矿(mineStone)引导及其前置工具引导(craftAxe/craftPickaxe)。
