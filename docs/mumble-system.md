...
本人历史工作台操作等级恰为二级时，满足普通台词间隔后以30%概率触发；抽签失败至少60秒后再试，成功说话后冷却900秒。本人成功放置或升级到三级及以上后不再触发，不受附近遗迹、村落或其他玩家工作台等级影响。使用20句随机牌堆，抽完前不重复，不直接报掉率；房主与客人各自本地播放，客人读取个人任务HUD中的工作台历史等级。
