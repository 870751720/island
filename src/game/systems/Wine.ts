...
export const WINES: WineDef[] = [
  { kind: 'wineBerry', name: '浆果酒', icon: '🍷', fxColor: '#a34a6b', hunger: 4, thirst: 2, health: 0, refresh: 45 },
  { kind: 'wineFruit', name: '苹果酒', icon: '🍶', fxColor: '#d9a441', hunger: 8, thirst: 4, health: 0, refresh: 60 },
  { kind: 'wineMilk', name: '奶酒', icon: '🥛', fxColor: '#f0e6d2', hunger: 10, thirst: 15, health: 5, refresh: 60 },
  { kind: 'wineGolden', name: '黄金酒', icon: '✨', fxColor: '#e6b422', hunger: 30, thirst: 30, health: 30, refresh: 90 },
];
