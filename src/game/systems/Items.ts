...
export const ITEMS: Record<ResourceKind, ItemDef> = {
  ...
  axe: {
    ...
    name: '木斧',
    icon: '🪓',
    description: '石头绑上树枝柄,砍树的必备工具;二级工作台可升级为石斧。',
  },
  pickaxe: {
    kind: 'pickaxe',
    name: '木镐',
    icon: '⛏️',
    description: '开采大石块的必备工具;二级工作台可升级为石镐。',
  },
  hoe: {
    kind: 'hoe',
    name: '木锄',
    icon: '⚒️',
    description: '手持锄头可以把浆果丛、灌木丛、草丛整棵挖出来搬走。',
  },
  fishingrod: {
    kind: 'fishingrod',
    name: '树枝鱼竿',
    icon: '🎣',
    description: '细枝绑上绳线做成的鱼竿,站在水边就能钓鱼;二级工作台可升级为木鱼竿。',
  },
  bow: {
    kind: 'bow',
    name: '树枝弓',
    icon: '🏹',
    description: '枝干弯成弓身、绳线做弦,手持时会自动射向附近的猎物;二级工作台可升级为木弓。',
  },
  sword: {
    kind: 'sword',
    name: '木剑',
    icon: '🗡️',
    description: '两段木头削成的近战武器,手持时靠近动物会自动挥砍,不会自动切换上手;二级工作台可升级为伤害更高的石剑。',
  },
  grassShirt: {
    kind: 'grassShirt',
    name: '草衣',
  ...
  berryBush: {
    ...
    name: '浆果丛',
    icon: '🍓',
    description: '用锄头挖出来的完整浆果丛。点击「使用」把它种回脚下(不能在水里,脚下也不能有别的东西),恢复一段时间后会继续结果。',
  },
  shrubBush: {
    kind: 'shrubBush',
    name: '灌木丛',
  ...
  workbench2: {
    ...
    name: '二级工作台',
    icon: '🛠️',
    description: '挖工作台搬来的二级工作台。点击「使用」放到脚下;二级起可制作二级工具等高级配方。',
  },
  workbench3: {
    kind: 'workbench3',
    name: '三级工作台',
