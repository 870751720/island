...
export const ITEMS: Record<ResourceKind, ItemDef> = {
  ...
  skateboard: { kind: 'skateboard', name: '滑板', icon: '🛹', description: '坐骑：四级工作台用木头×1、冒险家的经验书×1制作。装备后陆地移动速度增加120%，自动切换平衡、压低重心和舒展滑行姿态，双臂随重心摆动保持平衡，滑行中偶尔带板小跳。入水、作业、搬运、睡眠和死亡时暂时收起，恢复后自动乘骑；可在角色坐骑栏卸下。' },
  strawBackpack: {
    kind: 'strawBackpack',
    name: '草包',
    icon: '🎒',
  ...
  brewBarrel: {
    ...
    name: '酿酒桶',
    icon: '🍺',
    description: '铁箍橡木桶,把食材慢慢酿成酒,一次只酿一种。',
  },
  wineBerry: {
    kind: 'wineBerry',
    name: '浆果酒',
  ...
  plankPath: {
    ...
    description: '旧木板铺成的小路，板缝间还看得见草土。路上移速提升 10%，离开后恢复。',
  },
  gravelPath: {
    kind: 'gravelPath', name: '碎石小路', icon: '🪨',
    description: '把碎石铺成小路，让营地间的往来更轻快。路上移速提升 10%，离开后恢复。',
  },
  fenceStone: {
    kind: 'fenceStone',
    name: '石围栏',
