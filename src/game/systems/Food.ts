...
export const FOODS: Food[] = [
  { kind: 'berry', name: '浆果', icon: '🍒', action: 'eat_berry', fxColor: '#c0392b', hunger: 3, thirst: 2, health: 0 },
  ...
  { kind: 'fruitFruit', name: '苹果', icon: '🍎', action: 'eat_berry', fxColor: '#c0392b', hunger: 3, thirst: 2, health: 0 },
  { kind: 'carrot', name: '胡萝卜', icon: '🥕', action: 'eat_berry', fxColor: '#e07b2a', hunger: 8, thirst: 3, health: 0 },
  ...
  { kind: 'milk', name: '羊奶', icon: '🥛', action: 'eat_berry', fxColor: '#f6f1e4', hunger: 10, thirst: 25, health: 5 },
  ...
  { kind: 'cookedBerry', name: '烤浆果', icon: '🍬', action: 'eat_berry', fxColor: '#a0522d', hunger: 5, thirst: 1, health: 1 },
  ...
  { kind: 'boiledBerry', name: '煮浆果', icon: '🫐', action: 'eat_berry', fxColor: '#7a5cb0', hunger: 6, thirst: 3, health: 2 },
  ...
  { kind: 'potato', name: '土豆', icon: '🥔', action: 'eat_berry', fxColor: '#c9a06a', hunger: 5, thirst: 0, health: 0 },
  { kind: 'sweetPotato', name: '红薯', icon: '🍠', action: 'eat_berry', fxColor: '#c96a3a', hunger: 6, thirst: 1, health: 0 },
  { kind: 'corn', name: '玉米', icon: '🌽', action: 'eat_berry', fxColor: '#e8c56a', hunger: 6, thirst: 1, health: 0 },
  { kind: 'soybean', name: '大豆', icon: '🫘', action: 'eat_berry', fxColor: '#9aa74e', hunger: 3, thirst: 1, health: 0 },
  { kind: 'tomato', name: '番茄', icon: '🍅', action: 'eat_berry', fxColor: '#d94a3a', hunger: 4, thirst: 3, health: 1 },
  { kind: 'pepper', name: '辣椒', icon: '🌶️', action: 'eat_berry', fxColor: '#d93a2a', hunger: 2, thirst: 0, health: 2 },
  { kind: 'eggplant', name: '茄子', icon: '🍆', action: 'eat_berry', fxColor: '#6a3a8a', hunger: 4, thirst: 1, health: 0 },
  { kind: 'strawberry', name: '草莓', icon: '🍓', action: 'eat_berry', fxColor: '#d93a4a', hunger: 5, thirst: 4, health: 1 },
  { kind: 'cabbage', name: '卷心菜', icon: '🥬', action: 'eat_berry', fxColor: '#8fc47a', hunger: 6, thirst: 2, health: 0 },
  { kind: 'pumpkin', name: '南瓜', icon: '🎃', action: 'eat_berry', fxColor: '#e0862a', hunger: 8, thirst: 2, health: 0 },
  { kind: 'cookedPotato', name: '烤土豆', icon: '🍟', action: 'eat_berry', fxColor: '#c9a06a', hunger: 14, thirst: 0, health: 2 },
  { kind: 'boiledPotato', name: '土豆汤', icon: '🥣', action: 'eat_berry', fxColor: '#d9b98a', hunger: 11, thirst: 6, health: 3 },
  { kind: 'cookedSweetPotato', name: '烤红薯', icon: '🫔', action: 'eat_berry', fxColor: '#c96a3a', hunger: 16, thirst: 2, health: 3 },
  { kind: 'boiledSweetPotato', name: '红薯粥', icon: '🍚', action: 'eat_berry', fxColor: '#d99a6a', hunger: 12, thirst: 8, health: 4 },
  { kind: 'cookedCorn', name: '烤玉米', icon: '🍿', action: 'eat_berry', fxColor: '#e8c56a', hunger: 13, thirst: 1, health: 2 },
  { kind: 'boiledCorn', name: '玉米汤', icon: '🥣', action: 'eat_berry', fxColor: '#e3c56d', hunger: 10, thirst: 6, health: 3 },
  { kind: 'cookedSoybean', name: '烤豆', icon: '🥜', action: 'eat_berry', fxColor: '#9aa74e', hunger: 10, thirst: 1, health: 3 },
  { kind: 'boiledSoybean', name: '豆汤', icon: '🥣', action: 'eat_berry', fxColor: '#c9b98a', hunger: 8, thirst: 10, health: 5 },
  { kind: 'cookedTomato', name: '烤番茄', icon: '🥫', action: 'eat_berry', fxColor: '#d94a3a', hunger: 8, thirst: 2, health: 2 },
  { kind: 'boiledTomato', name: '番茄汤', icon: '🥣', action: 'eat_berry', fxColor: '#d96a4a', hunger: 7, thirst: 9, health: 4 },
  { kind: 'cookedPepper', name: '烤辣椒', icon: '🥵', action: 'eat_berry', fxColor: '#d93a2a', hunger: 6, thirst: 0, health: 4 },
  { kind: 'boiledPepper', name: '辣椒汤', icon: '🍲', action: 'eat_berry', fxColor: '#c94a2a', hunger: 5, thirst: 4, health: 6 },
  { kind: 'cookedEggplant', name: '烤茄子', icon: '🫕', action: 'eat_berry', fxColor: '#6a3a8a', hunger: 12, thirst: 1, health: 3 },
  { kind: 'boiledEggplant', name: '茄子汤', icon: '🍲', action: 'eat_berry', fxColor: '#8a5aaa', hunger: 9, thirst: 6, health: 4 },
  { kind: 'cookedStrawberry', name: '烤草莓', icon: '🍯', action: 'eat_berry', fxColor: '#d93a4a', hunger: 7, thirst: 1, health: 2 },
  { kind: 'boiledStrawberry', name: '草莓汤', icon: '🍧', action: 'eat_berry', fxColor: '#e38ab0', hunger: 6, thirst: 8, health: 4 },
  { kind: 'cookedCabbage', name: '烤卷心菜', icon: '🥗', action: 'eat_berry', fxColor: '#8fc47a', hunger: 10, thirst: 2, health: 2 },
  { kind: 'boiledCabbage', name: '蔬菜汤', icon: '🥣', action: 'eat_berry', fxColor: '#a9c47a', hunger: 8, thirst: 8, health: 4 },
  { kind: 'cookedPumpkin', name: '烤南瓜', icon: '🥧', action: 'eat_berry', fxColor: '#e0862a', hunger: 18, thirst: 3, health: 4 },
  { kind: 'boiledPumpkin', name: '南瓜浓汤', icon: '🍲', action: 'eat_berry', fxColor: '#e8a04a', hunger: 14, thirst: 12, health: 6 },
