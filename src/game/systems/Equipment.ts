...
export const EQUIPMENT: Record<EquipKind, EquipmentDef> = {
  ...
  ironShirt: { kind: 'ironShirt', slot: 'clothing', score: 5, defense: 5, reduce: 0.3, bodyColor: '#6dada6' },
  ironPants: { kind: 'ironPants', slot: 'pants', score: 5, defense: 4, reduce: 0.26, bodyColor: '#4f8580' },
