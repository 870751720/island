...
const SINGLE_OUTPUTS: ReadonlySet<ResourceKind> = new Set([
  'feedBarrel', 'bed1', 'bed2', 'bed3', 'baitBarrel', 'brewBarrel', 'doghouse', 'waterPurifier', 'smelter', 'loom', 'mill', 'cookingStation', 'researchTable',
  'workbench1', 'campfire',
]);
...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    id: 'fishKeep',
    name: '鱼护',
    cost: { rope: 10, wood: 2, ironIngot: 2 },
    station: 'workbench',
    output: 'fishKeep',
    minBenchLevel: 4,
  },
  ...
  },
  {
    id: 'brewBarrel',
    name: '酿酒桶',
    cost: { ironIngot: 3, wood: 1, adventureBook: 1 },
    station: 'workbench',
    output: 'brewBarrel',
    minBenchLevel: 3,
  },
  ...
  },
  {
    id: 'loom',
    name: '纺织机',
    cost: { wood: 15, branch: 5, rope: 5, fur: 5 },
    station: 'workbench',
    output: 'loom',
    minBenchLevel: 3,
  },
  {
    id: 'cookingStation',
    name: '烹饪台',
    cost: { deadCampfire: 1, ironIngot: 5 },
    station: 'workbench',
