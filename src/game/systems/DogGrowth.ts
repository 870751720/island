...
export type DogGmCommand = 'stage' | 'xp' | 'cooldowns' | 'recall' | 'rescue' | 'companion' | 'protect' | 'emojiAlert' | 'emojiBite' | 'emojiGuard';
export const DOG_GM_COMMANDS: readonly DogGmCommand[] = ['stage', 'xp', 'cooldowns', 'recall', 'rescue', 'companion', 'protect', 'emojiAlert', 'emojiBite', 'emojiGuard'];
