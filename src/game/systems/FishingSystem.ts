...
export class FishingSystem {
  ...
  constructor(
    ...
    /** 钓鱼杂物概率的降低量(百分点,波塞冬神像每层为 1，最多 10) */
  ...
  /** 抛竿;rainBoost/snowBoost 为雨天雨水恩泽/雪天雪之馈赠:档位权重向上偏移(仅房主结算端生效) */
  start(rainBoost = false, snowBoost = false): boolean {
    ...
    this.tier =
      baited && pity.count >= TIER4_PITY_CASTS
        ? 4
        : rollTier(baited, this.junkCut(), rainBoost, snowBoost, {
