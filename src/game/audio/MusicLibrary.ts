...
function score(name: string, title: string, group: MusicGroup, bpm: number,
  beatsPerBar: number, waltz: boolean, tonic: number, roots: number[], melody: string): Piece {
  return {
    name, title, group, bpm, beatsPerBar, waltz,
...
export const MUSIC_GROUP_LABELS: Record<MusicGroup, string> = {
  spring: '春日', summer: '盛夏', autumn: '金秋', winter: '冬雪', fishing: '钓鱼', classic: '原有曲目',
};
...
export const MUSIC_PIECES: Piece[] = [
  ...
  score('summer-shade', '树荫午睡', 'summer', 64, 4, false, 67, [0, 2, 5, 0, 9, 5, 7, 0],
    '79 83 86|81 83|84 83 79|86|83 81 79|84 88|86 81|79|86 88 86|83 81|84 86 88|86 83|83 79 76|81 84|81 78|79'),
  score('summer-tide', '蓝湾晚风', 'summer', 60, 3, false, 60, [0, 9, 5, 7, 0, 2, 7, 0],
    '79 76|81 79 76|77 81|74|76 79 84|81 77|79 74|72|84 79|81 84 83|81 77|79 83|84 79 76|77 74|74 71|72'),
