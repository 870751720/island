...
export type ShrineKind = 'poseidonBlessing' | 'beehiveShrine' | 'healCrystal' | 'rainAltar' | 'crocIncense';
...
export class Shrine extends Facility<ShrineKind> {
