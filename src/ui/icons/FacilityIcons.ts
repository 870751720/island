...
export const FACILITY_SVG = {
 ...
 fishKeep:svg(chest(false)+p('M22 33Q31 24 39 33Q31 42 22 33M39 33L46 27V39Z','#70aaa2')+e(27,32,1,1,dark)),crate:svg(chest(false)),ironCrate:svg(chest(true)),baitBarrel:svg(barrel(wood)+p('M24 37Q32 29 40 37Q33 44 24 37',cream)+e(28,36,1,1,dark)),brewBarrel:svg(barrel('#aa7b60')+e(32,37,6,6,'#ad7185')+p('M31 31Q33 25 40 28Q39 33 31 31',green)),
