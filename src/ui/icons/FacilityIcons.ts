...
export const FACILITY_SVG = {
 plankPath:svg([0,1,2,3].map((i)=>g(`translate(${i*5} ${-i*8})`,p('M8 41L34 50L49 44L22 35Z',['#a77c51','#bc9568','#96734f','#b18a61'][i],dark,1)+l('M16 41L34 47','#795b3e',1))).join('')),
 ...
 fishKeep:svg(e(32,55,18,3,'#58462a15')+p('M15 16L18 49Q32 58 46 49L49 16','#c3ba9133',dark)+l('M16 19L45 48M16 30L36 53M18 43L27 53M25 15L47 37M36 14L48 26M48 19L19 48M48 30L28 53M46 43L37 53M39 15L17 37M28 14L16 26','#ac9569',1.4)+p('M18 48a14 5 0 1 0 28 0a14 5 0 1 0-28 0','none',metal)+p('M16 33a16 5 0 1 0 32 0a16 5 0 1 0-32 0','none',metal)+p('M15 16a17 6 0 1 0 34 0a17 6 0 1 0-34 0','#536c6033',metal)+p('M18 16a14 4 0 1 0 28 0a14 4 0 1 0-28 0','none',cream)),crate:svg(chest(false)),ironCrate:svg(chest(true)),baitBarrel:svg(barrel(wood)+p('M24 37Q32 29 40 37Q33 44 24 37',cream)+e(28,36,1,1,dark)),brewBarrel:svg(barrel('#aa7b60')+e(32,37,6,6,'#ad7185')+p('M31 31Q33 25 40 28Q39 33 31 31',green)),
