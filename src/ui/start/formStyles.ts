...
.profile-mask{position:fixed;inset:0;z-index:30;display:flex;overflow-y:auto;padding:calc(20px + env(safe-area-inset-top)) 20px calc(20px + env(safe-area-inset-bottom));background:linear-gradient(160deg,#d2e3e9ed,#a8c8dbf5 53%,#8cb4cef5)}
