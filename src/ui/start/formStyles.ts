...
.profile-mask,.room-lobby{--ink:#304f4b;--muted:#6a7c70;--line:#315b4d26;color:var(--ink);font-family:Arial,"PingFang SC","Microsoft YaHei",sans-serif;box-sizing:border-box}
...
.profile-mask button:focus-visible,.room-lobby button:focus-visible{outline:3px solid #bc793e;outline-offset:3px}
...
.profile-confirm,.room-button{width:100%;min-height:54px;margin-top:22px;border:1px solid #e0af72;border-radius:12px;background:linear-gradient(115deg,#ffdaa0,#eeb174);color:#513e2d;font-weight:700!important;letter-spacing:.08em;box-shadow:0 4px 0 #b67d4f}
