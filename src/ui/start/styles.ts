...
@container game-viewport (orientation:landscape) and (max-height:450px){.menu-footer{display:none}.menu-actions{padding:10px 12px 4px}.start-button{min-height:52px}.mp-button{min-height:44px}.start-mp{margin-top:10px}.menu-utilities{margin-top:3px}.menu-save-label{margin-bottom:6px}.mode-row{margin-bottom:6px}}
