...
.abandon-mask{position:fixed;inset:0;z-index:20;display:flex;overflow-y:auto;align-items:center;justify-content:center;padding:calc(24px + env(safe-area-inset-top)) 24px calc(24px + env(safe-area-inset-bottom));background:#1a322b8f}
