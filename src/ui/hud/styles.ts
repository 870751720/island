...
.quest-feedback-anchor{position:absolute;left:0;top:0;width:max-content;max-width:min(220px,calc(100vw - 24px));visibility:hidden;pointer-events:none;z-index:25;font-family:Arial,"PingFang SC","Microsoft YaHei",sans-serif}.quest-feedback{padding:8px 12px;border-radius:12px;background:linear-gradient(145deg,#fff8dff5,#dfeacdf5);border:1px solid #c4ce9a;box-shadow:0 3px 12px #314c3e30;text-align:center;color:#355b32;animation:quest-complete 4s both}.quest-feedback>strong{display:block;font-size:15px;line-height:1.4;color:#386738}.quest-feedback-title{display:block;font-size:11px;line-height:1.5}.quest-received{display:flex;justify-content:center;flex-wrap:wrap;gap:2px 6px;font-size:11px;line-height:1.5;color:#76531e}.quest-received>span{display:inline-flex;align-items:center;gap:2px}.quest-received>span:first-child{width:100%;justify-content:center;font-weight:700}
@keyframes quest-complete{0%{opacity:0;transform:translateY(8px) scale(.85)}8%{opacity:1;transform:translateY(0) scale(1.06)}14%,85%{opacity:1;transform:scale(1)}100%{opacity:0;transform:translateY(-10px) scale(.98)}}
@media(prefers-reduced-motion:reduce){.quest-feedback{animation:none}}
