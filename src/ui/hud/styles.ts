...
@media(prefers-reduced-motion:reduce){.quest-feedback{animation:none}.quest-reward-flight{animation-name:quest-reward-reduced;animation-duration:.4s;transform:translate(calc(-50% + var(--flight-x)),calc(-50% + var(--flight-y)))}}
