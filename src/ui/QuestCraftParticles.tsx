...
export function QuestCraftParticles({ radius = 16 }: { radius?: number }) {
  return <span className={styles.orbit} style={{ '--orbit-radius': `${radius}px` } as CSSProperties} aria-hidden="true">
