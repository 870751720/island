...
export const GUIDE_ENTRIES: readonly GuideEntry[] = [
  ...
  },
  {
    ...
    sections: [
      { title: '开垦与播种', text: ['手持', item('hoe', '锄'), '，在无障碍的干地调整到绿色预览并站定，自动开出土壤。再手持', item('carrotSeed', '胡萝卜种子'), '或其他作物种子，对准空土壤站定即可连续播种，播完一格紧接下一格，无需等候或移动重触发；附近无空位或种子用完时停止。树种也可在合适的干地连续播种，移动会暂停播种。'] },
