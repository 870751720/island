...
export const GUIDE_ENTRIES: readonly GuideEntry[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: '发现新料理', text: ['三级工作台可制作', item('researchTable', '料理研究台'), '。按线索投入一到四种食材，每种一份，顺序不限；研究两秒，正确组合一定成功，获得一份成品并解锁食谱。失败消耗材料并等待五秒。研究或获得成品的发现记录跨存档保留，未发现的料理在图鉴中显示待发现；已发现页可查看搭配和烹饪用量。'] },
