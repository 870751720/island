...
export const GUIDE_ENTRIES: readonly GuideEntry[] = [
  ...
  },
  {
    ...
    sections: [
      { title: '开垦与播种', text: ['手持', item('hoe', '锄'), '，在无障碍的干地调整到绿色预览并站定，自动开出土壤。再手持', item('carrotSeed', '胡萝卜种子'), '或其他作物种子，对准空土壤站定播种。'] },
      { title: '成熟后采收', text: ['作物会从幼苗逐渐长到成熟。空手靠近成熟作物并站定即可采收，获得作物与对应种子，继续播种形成循环。', item('carrot', '胡萝卜'), '可以食用或烹饪；', item('wheat', '小麦'), '可以烤成', item('bread', '烤面包'), '。'] },
  ...
  },
  {
    ...
    sections: [
      { title: '捕捉与投喂', text: ['用', item('lasso', '套索'), '抓住', creature('rabbit', '兔子'), '、', creature('sheep', '羊'), '或', creature('bison', '野牛'), '后，主动丢下适合它吃的食物，等待它进食并填满爱心。首次驯养不能靠食料桶完成；点击生物名称可查看食谱。'] },
      { title: '持续照料', text: ['驯养后可以用', item('feedBarrel', '食料桶'), '供食。爱心会逐渐减少，归零后恢复野生；', creature('wolf', '狼'), '和', creature('bear', '熊'), '会重新具有攻击性。这两种猛兽首次捕捉还需等待挣脱判定结束，驯养成功前仍然危险。'] },
      { title: '领取产物', text: ['成年驯养羊与野牛可产奶，靠近站定自动挤奶。羊还会长出', item('wool', '羊毛'), '，手持', item('shears', '剪刀'), '靠近即可剪毛。幼崽需要长大后才生产，已备好的产物未领取不会继续累积。'] },
    ],
  },
  {
