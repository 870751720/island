...
h.bear.pos.set(31, 0, 0);
h.player.group.position.set(3, 0, 0);
h.wildlife.updateTaunt(h.bear, 0.01, 5.2);
assert.ok(h.bear.taunt, '距初始点已超30米，但距移动后的玩家不足30米');
h.bear.pos.set(33, 0, 0);
h.wildlife.updateTaunt(h.bear, 0, 5.3);
assert.ok(h.bear.taunt, '恰好30米仍保护熊');
h.bear.pos.set(33.01, 0, 0);
