/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=signaling/wrangler.jsonc signaling/worker-configuration.d.ts` (hash: e0d40921fe246891a6c47cfc7df61df8)
